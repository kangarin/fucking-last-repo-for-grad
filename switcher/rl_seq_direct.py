...
class ActorCritic(nn.Module):
    def __init__(self, input_size, hidden_size, num_actions=5, lstm_layers=1):
        super().__init__()
...
class A2CAgent:
    def __init__(self, state_buffer, observation_duration=5.0, decision_duration=5.0):
        ...
        self.model_save_path = self.model_save_dir / f'model_direct_actions_seq.pt'
    ...
    def normalize_state(self, state):
        ...
        try:
            ...
            # 合并所有特征
            all_features = list(base_features.values())
            return all_features
    ...
    def compute_reward(self, states, action_idx):
        ...
        try:
            ...
            # 计算基础奖励
            queue_ratio = avg_metrics['queue_length'] / self.queue_low_threshold_length
